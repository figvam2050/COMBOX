...
- Опитування здійснюється за адресою **`0x10`**: `10 03 00 00 00 27 06 91` (39 регістрів).
- Батарея повертає 83 байти даних: `10 03 4E 13 3F 00 00 ...` (49.27 В, 100% SOC / SOH).
- **Карта регістрів:**
  - `Reg 0`: Напруга 49.27 В (0.01 В)
  - `Reg 1`: Струм 0.00 А (0.01 А)
  - `Reg 2..16`: 15 комірок (3.12 В .. 3.28 В)
  - `Reg 17`: 0 (16-та комірка відсутня у 15S паку)
  - `Reg 18..21`: 4 температури (23°C MOS, 22°C Cell1, 22°C Cell2, 15°C Env)
  - `Reg 22`: SOC = 100%
  - `Reg 23`: SOH = 100%
  - `Reg 24`: Cycles = 31
  - `Reg 37`: Max Charge/Discharge Current = 100.0 A (`0x03E8`)
- Заводська прошивка Felicity опитувала адресу `0x1E` регістр `0x0100` (`1E 03 01 00 00 20`), через що не бачила батарею Vision. Нова прошивка повністю адаптована під протокол Vision.
